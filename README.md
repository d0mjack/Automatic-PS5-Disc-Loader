# Automatic-PS5-Disc-Launcher
An external device that will use rails to transfer disks from the stack to the ps5. It will hopefully be controlled by a web app, so I can switch which physical game I want to play without having to get up.

The shells will be made with 3d printed parts and I will use a Raspberry Pi Pico 2 W for the brain.
